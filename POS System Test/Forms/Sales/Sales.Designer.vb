...
Partial Class Sales
    ...
    Private Sub InitializeComponent()
        ...
        pnlContainer.Controls.Add(btnSearch)
        ...
        pnlContainer.Controls.Add(txbxQty)
        pnlContainer.Controls.Add(dgvAddedList)
        pnlContainer.Controls.Add(btAddStock)
        pnlContainer.Controls.Add(cbxCategory)
        pnlContainer.Controls.Add(lbCat)
        pnlContainer.Controls.Add(lbID)
        pnlContainer.Controls.Add(lbProduct)
        ...
        btVoid.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btVoid.FillColor = Color.DimGray
        btVoid.Font = New Font("Segoe UI", 9F)
        ...
        lblQuantity.Location = New Point(39, 149)
        ...
        txbxQty.Location = New Point(100, 149)
        ...
        dgvAddedList.ThemeStyle.HeaderStyle.BackColor = SystemColors.ControlDark
        ...
        cbxCategory.Location = New Point(434, 141)
        cbxCategory.Name = "cbxCategory"
        cbxCategory.Size = New Size(156, 23)
        cbxCategory.Sorted = True
        cbxCategory.TabIndex = 31
        ...
        lbCat.Location = New Point(373, 141)
        lbCat.Name = "lbCat"
        ...
        lbProduct.BackColor = Color.Transparent
        lbProduct.Location = New Point(39, 88)
        lbProduct.Name = "lbProduct"
        lbProduct.Size = New Size(49, 15)
        lbProduct.TabIndex = 28
        ...
        txbxID.Location = New Point(100, 34)
        txbxID.Name = "txbxID"
        ...
        txbxProduct.Location = New Point(100, 88)
        ...
        txbxProduct.Size = New Size(162, 36)
        ...
        lblName.Location = New Point(373, 16)
        ...
        txbxName.Location = New Point(410, 34)
        ...
        btnSearch.FillColor = Color.DimGray
        btnSearch.Font = New Font("Segoe UI", 9F)
        btnSearch.ForeColor = Color.White
        btnSearch.Location = New Point(268, 88)
        btnSearch.Name = "btnSearch"
        btnSearch.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        btnSearch.Size = New Size(74, 36)
